...
document](../../design-doc/overview), this has both privacy and security implications.
...
Vanilla multisig transactions would address this, but it's not clear if it's
